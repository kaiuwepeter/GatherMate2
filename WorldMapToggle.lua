...
local function CreateToggleButton()
	...
	toggleButton:SetScript("OnEnter", function(self)
		...
		local db = GatherMate.db.profile
		if db.showWorldMap then
			GameTooltip:AddLine(L["Nodes shown"], 0, 1, 0)
		else
			GameTooltip:AddLine(L["Nodes hidden"], 1, 0, 0)
		end
		GameTooltip:AddLine(" ")
...
GatherMate.RegisterCallback = GatherMate.RegisterCallback or function() end
...
-- Initialize on load if WorldMap is already shown
