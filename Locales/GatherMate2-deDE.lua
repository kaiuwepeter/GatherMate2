...
-- Farmbar Options
L["Farmbar"] = "Farmbar"
L["Farmbar Settings"] = "Farmbar Einstellungen"
L["The Farmbar displays collected herbs, seeds, ores and fish. For each herb/ore 2 IDs are counted and added, seeds and fish have 1 ID."] = "Die Farmbar zeigt gesammelte Kräuter, Samen, Erze und Fische an. Pro Kraut/Erz werden 2 IDs gezählt und addiert, Samen und Fische haben 1 ID."
L["Enable Farmbar"] = "Farmbar aktivieren"
L["Shows a bar with collected items"] = "Zeigt eine Bar mit gesammelten Items an"
L["Show Herbs"] = "Kräuter anzeigen"
L["Shows collected herbs and seeds in the Farmbar"] = "Zeigt gesammelte Kräuter und Samen in der Farmbar"
L["Show Ores"] = "Erze anzeigen"
L["Shows collected ores in the Farmbar"] = "Zeigt gesammelte Erze in der Farmbar"
L["Show Fish"] = "Fische anzeigen"
L["Shows caught fish in the Farmbar"] = "Zeigt gefangene Fische in der Farmbar"
L["Debug Mode"] = "Debug-Modus"
L["Shows debug information in chat"] = "Zeigt Debug-Informationen im Chat"
L["Refresh"] = "Aktualisieren"
L["Manually refresh the Farmbar"] = "Farmbar manuell aktualisieren"
L["Reset Positions"] = "Positionen zurücksetzen"
L["Resets all Farmbar positions"] = "Setzt alle Farmbar-Positionen zurück"
L["Scan Inventory"] = "Inventar scannen"
L["Shows all found items in chat"] = "Zeigt alle gefundenen Items im Chat"
L["Farmbar loaded! Use /gmfarmbar for options."] = "Farmbar geladen! Verwende /gmfarmbar für Optionen."
L["Farmbar activated"] = "Farmbar aktiviert"
L["Farmbar deactivated"] = "Farmbar deaktiviert"
L["Farmbar updated"] = "Farmbar aktualisiert"
L["Farmbar positions reset"] = "Farmbar Positionen zurückgesetzt"
L["Debug mode"] = "Debug-Modus"
...
L["=== Inventory Scan ==="] = "=== Inventar-Scan ==="
L["Herbs:"] = "Kräuter:"
L["Seeds:"] = "Samen:"
L["Ores:"] = "Erze:"
L["Fish:"] = "Fische:"
L["total"] = "gesamt"
L["GatherMate2 Farmbar Commands:"] = "GatherMate2 Farmbar Befehle:"
L["/gmfarmbar toggle - Enable/disable Farmbar"] = "/gmfarmbar toggle - Farmbar an/aus"
L["/gmfarmbar reset - Reset positions"] = "/gmfarmbar reset - Positionen zurücksetzen"
L["/gmfarmbar refresh - Refresh Farmbar"] = "/gmfarmbar refresh - Farmbar aktualisieren"
L["/gmfarmbar debug - Enable/disable debug mode"] = "/gmfarmbar debug - Debug-Modus an/aus"
L["/gmfarmbar scan - Scan inventory (shows IDs)"] = "/gmfarmbar scan - Inventar scannen (zeigt IDs)"
L["/gmfarmbar config - Open options"] = "/gmfarmbar config - Optionen öffnen"
L["Unknown command. Use /gmfarmbar help"] = "Unbekannter Befehl. Verwende /gmfarmbar help"
